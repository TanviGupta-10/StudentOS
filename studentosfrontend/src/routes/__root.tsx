    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          This page took a study break. Let's get you back.
        </p>
        <a href="/" className="mt-6 inline-flex items-center justify-center rounded-md gradient-primary-bg px-5 py-2.5 text-sm font-medium text-primary-foreground shadow-glow">
          Back home
        </a>
      </div>
    </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "StudentOS — Your AI-Powered Study Companion" },
      { property: "og:description", content: "Plan smarter, study better, and achieve your goals with AI." },
